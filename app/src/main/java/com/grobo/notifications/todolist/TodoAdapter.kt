...
//
//class TodoAdapter : RecyclerView.Adapter<RecyclerViewAdapter.TaskViewHolder>() {
//
//    private var mTaskList = arrayListOf<Goal>()
//    private lateinit var mContext: Context
//
//    fun updateData(tasks: List<Goal>) {
//        mTaskList = tasks as ArrayList<Goal>
